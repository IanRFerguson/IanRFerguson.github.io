...
db_path = os.path.join(here, "new_york", "nyc.db")
...
class MapHandler:
    ...
    def __init__(
        self, output_path: os.path = os.path.join(here, "templates", "hotpots.html")
    ):
    ...
    def read_db(self):
        ...
        with sqlite3.connect(db_path) as connection:
            df = pd.read_sql_query(sql="select * from nyc;", con=connection)
    ...
    def build_map(self):
        ...
        # Instantiate map
        nyc_map = folium.Map(location=self.coords, zoom_start=12)
